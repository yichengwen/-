 ...
 * @author  __USER__
 */
public class ApplyGoodsView extends javax.swing.JFrame {
	ApplyGoods applygoods;
	Admin a = new Admin();

	/** Creates new form ApplyShopView 
	 * @throws ClassNotFoundException */
	public ApplyGoodsView(ApplyGoods applygoods) throws ClassNotFoundException {
	...
	public void init() throws SQLException, ClassNotFoundException {
		...
		ArrayList<String> details = a.getApplyGoods(applygoods.getApgid() + "");
		this.jTextField7.setText(details.get(0));
		this.jTextField6.setText(details.get(6));
		this.jTextField5.setText(details.get(1));
		this.jTextField2.setText(details.get(3));
		this.jTextField3.setText(details.get(5));
		this.jTextField4.setText(details.get(4));
		this.jTextField8.setText(details.get(2));
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt)
		...
		// TODO add your handling code here:
		try {
			a.rejectApplyGoods(applygoods.getApgid());
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt)
			throws ClassNotFoundException {
		try {
			a.acceptApplyGoods(applygoods.getApgid());
			String gname = this.jTextField5.getText();
			int sid = Integer.parseInt(this.jTextField6.getText());
			String gcentent = this.jTextField4.getText();
			String gtype = this.jTextField2.getText();
			String gprice = this.jTextField8.getText();
			a.acceptAddGoods(gname, sid, gcentent, gtype, gprice);
			JOptionPane.showMessageDialog(this, "ok");
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			JOptionPane.showMessageDialog(this, "no");
