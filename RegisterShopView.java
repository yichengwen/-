 ...
 * @author  __USER__
 */
public class RegisterShopView extends javax.swing.JFrame {
	User u = new User();
	String uid;

	/** Creates new form RegisterView */
	public RegisterShopView(String uid) {
		this.uid = uid;
		initComponents();
	...
	private void initComponents() {
		...
		jLabel4.setForeground(new java.awt.Color(205, 205, 255));
		jLabel4.setText("\u6ce8\u518c\u5e97\u94fa");
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(
				...
				jPanel3Layout.createSequentialGroup().addContainerGap(179,
						Short.MAX_VALUE).addComponent(jLabel4).addGap(104, 104,
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			...
			String d = this.jPasswordField1.getText();
			String c = this.jTextArea1.getText();
			u.registershop(a, b, c, d);
			JOptionPane.showMessageDialog(this, "ÒÑÌá½»ÉêÇë");
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			JOptionPane.showMessageDialog(this, "×¢²áÊ§°Ü");
			e.printStackTrace();
	...
	//			public void run() {
	//				new RegisterShopView().setVisible(true);
	//			}
	//		});
	//	}
